...
class Deployer {
    constructor(accounts) {
        ...
        // web3.eth.personal.unlockAccount(accounts[0],'123',function(error,result){ 
        //     if(error){
        ...
        // })
            this.deployInnerProductVerifier = () => {
                ...
                return new Promise((resolve, reject) => {
                    contract.deploy({ data: InnerProductVerifier.bytecode }).send({ from: accounts[0], gas: 470000000000,gasPrice:3 })
                        .on("receipt", (receipt) => {
            ...
            this.deployZetherVerifier = (ip) => {
                ...
                return new Promise((resolve, reject) => {
                    contract.deploy({ data: ZetherVerifier.bytecode, arguments: [ip] }).send({ from: accounts[0], gas: 80000000000,gasPrice:3 })
                        .on("receipt", (receipt) => {
            ...
            this.deployBurnVerifier = (ip) => {
                ...
                return new Promise((resolve, reject) => {
                    contract.deploy({ data: BurnVerifier.bytecode, arguments: [ip] }).send({ from: accounts[0], gas: 47000000000,gasPrice:3 })
                        .on("receipt", (receipt) => {
            ...
            this.deployCashToken = () => {
                ...
                return new Promise((resolve, reject) => {
                    contract.deploy({ data: CashToken.bytecode }).send({ from: accounts[0], gas: 47000000000,gasPrice:3 })
                        .on("receipt", (receipt) => {
            ...
            this.mintCashToken = (cash, amount) => {
                ...
                return new Promise((resolve, reject) => {
                    contract.methods.mint(accounts[0], amount).send({ from: accounts[0], gas: 47000000000,gasPrice:3 })
                        .on("receipt", (receipt) => {
            ...
            this.approveCashToken = (cash, zsc, amount) => {
                const contract = new web3.eth.Contract(CashToken.abi, cash);
                return new Promise((resolve, reject) => {
                    contract.methods.approve(zsc, amount).send({ from: accounts[0], gas: 47000000000,gasPrice:3 })
                        .on("receipt", (receipt) => {
            ...
            this.deployZSC = (cash, zether, burn, epochLength) => {
                ...
                return new Promise((resolve, reject) => {
                    contract.deploy({ data: ZSC.bytecode, arguments: [cash, zether, burn, epochLength] }).send({ from: accounts[0], gas: 4700000000,gasPrice:3 })
                        .on("receipt", (receipt) => {
